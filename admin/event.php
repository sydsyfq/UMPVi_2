      ...
      <table class="table table-striped table-bordered">
        <thead>
          ...
          <tr>
            ...
            <td><input style="width: 500px;" type="date" name="eventDate" required="required"></td>
          </tr>
          <tr>
            <th scope="col">Event Time Start: </th>
            <td><input style="width: 500px;" type="time" name="eventTimeStart" required="required"></td>
          </tr>
          <tr>
            <th scope="col">Event Time End: </th>
            <td><input style="width: 500px;" type="time" name="eventTimeEnd" required="required"></td>
          </tr>
        </thead>
        <tbody>
